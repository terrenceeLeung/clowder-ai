...
### 9. knowledge-map.yaml 模块设计（2026-04-22，实施计划阶段回退）

**触发**：CVO 在 writing-plans 阶段指出初版 4 模块（记忆、协作、游戏、基础设施）太粗，要求回退到设计阶段重新梳理 Cat Cafe 核心模块。

**分析方法**：全量扫描 176 个 feature spec + 14 个后端 domain + 19 个 ADR + 前端组件结构，按产品叙事（非代码结构）聚类。

**最终方案——8 个核心模块**（CVO 确认通过）：

| 模块 ID | 名称 | Anchors 数 | 核心内容 |
|---------|------|-----------|---------|
| memory | 记忆与知识工程 | 7 | F102/F163/F152/F100/F169 + ADR-020/015 |
| collaboration | 多猫协作 | 7 | F002/F027/F055/F167/F037 + ADR-001/002 |
| games | 游戏系统 | 6 | F101/F090/F107/F119/F093/F044 |
| messaging | 消息与富交互 | 7 | F022/F109/F020/F034/F035/F039 + ADR-008 |
| guidance | 引导与教学 | 4 | F155/F110/F165/F056 |
| integration | 外部连接与生态 | 7 | F146/F151/F126/F021/F054/F129 + ADR-014 |
| infrastructure | 基础设施 | 8 | F048/F113/F143/F149/F153/F156/F025 + ADR-022 |
| identity | 猫猫身份与治理 | 6 | F127/F038/F077/F067/F168 + ADR-009 |

**设计考量**：
- 8 模块 vs 初版 4 模块：Cat Cafe 知识域比预想广，4 个太粗导致单模块 anchor 20+，导览无法聚焦
- 每模块 4-8 anchors，一次导览 30-60 分钟可覆盖
- F100 Self-Evolution 放记忆而非身份——核心是知识对象化，和记忆系统强耦合
- 模块边界参考后端 domain 但不完全对齐——产品叙事 > 代码结构
- 所有 48 个 anchor 路径已验证文件存在

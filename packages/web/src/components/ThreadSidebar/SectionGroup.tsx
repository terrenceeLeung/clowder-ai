...
const ICON_PATHS: Record<string, string> = {
  ...
  feynman:
    'M2 3.75C2 2.784 2.784 2 3.75 2h8.5c.966 0 1.75.784 1.75 1.75v8.5A1.75 1.75 0 0112.25 14H3.75A1.75 1.75 0 012 12.25v-8.5zm1.75-.25a.25.25 0 00-.25.25v8.5c0 .138.112.25.25.25h8.5a.25.25 0 00.25-.25v-8.5a.25.25 0 00-.25-.25h-8.5zM5 6.25a.75.75 0 01.75-.75h4.5a.75.75 0 010 1.5h-4.5A.75.75 0 015 6.25zm.75 2.25a.75.75 0 000 1.5h2.5a.75.75 0 000-1.5h-2.5z',
};
...
const ICON_COLORS: Record<string, string> = {
  ...
  feynman: 'text-emerald-500',
};

interface SectionGroupProps {
  label: string;
  icon?: 'pin' | 'star' | 'clock' | 'archive' | 'system' | 'feynman';
  count: number;
  isCollapsed: boolean;
  onToggle: () => void;
  projectPath?: string;
